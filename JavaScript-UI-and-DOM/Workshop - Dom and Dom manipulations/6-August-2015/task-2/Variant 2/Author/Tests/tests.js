...
var result = require('../Source/solution');
...
describe('Task #2 Tests - Datepicker', function () {
    ...
    it('should be shown on input click', function () {
        ...
        var element = $('.datepicker-wrapper .datepicker-content');
        var isVisibleBefore = element.hasClass('datepicker-content-visible');
        ...
        var isVisibleAfter = element.hasClass('datepicker-content-visible');
    ...
    it('should populate the input value correctly when selecting from the table', function () {
        ...
        function testTable(date, number, cellIndex) {
            ...
            var isVisible = $('.datepicker-wrapper .datepicker-content').hasClass('datepicker-content-visible');
